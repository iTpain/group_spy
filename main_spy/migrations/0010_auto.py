...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PostObservation', fields ['date']
        db.create_index('main_spy_postobservation', ['date'])


    def backwards(self, orm):
        
        # Removing index on 'PostObservation', fields ['date']
        db.delete_index('main_spy_postobservation', ['date'])
