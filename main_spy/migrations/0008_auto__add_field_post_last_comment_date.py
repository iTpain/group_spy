...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_spy_post', 'last_comment_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.last_comment_date'
        db.delete_column('main_spy_post', 'last_comment_date')
