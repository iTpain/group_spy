...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.last_comment_date'
        db.alter_column('main_spy_post', 'last_comment_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Post.last_comment_date'
        db.alter_column('main_spy_post', 'last_comment_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
