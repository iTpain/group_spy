...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_spy_user', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'User.last_name'
        db.alter_column('main_spy_user', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'User.last_scanned'
        db.alter_column('main_spy_user', 'last_scanned', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'User.age'
        db.alter_column('main_spy_user', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'User.city_alias'
        db.alter_column('main_spy_user', 'city_alias', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'User.education'
        db.alter_column('main_spy_user', 'education', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'User.first_name'
        db.alter_column('main_spy_user', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'User.last_name'
        db.alter_column('main_spy_user', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'User.last_scanned'
        db.alter_column('main_spy_user', 'last_scanned', self.gf('django.db.models.fields.DateTimeField')(default=0))

        # Changing field 'User.age'
        db.alter_column('main_spy_user', 'age', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'User.city_alias'
        db.alter_column('main_spy_user', 'city_alias', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'User.education'
        db.alter_column('main_spy_user', 'education', self.gf('django.db.models.fields.IntegerField')(default=''))
