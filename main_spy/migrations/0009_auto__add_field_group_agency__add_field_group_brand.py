...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.agency'
        db.add_column('main_spy_group', 'agency', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Group.brand'
        db.add_column('main_spy_group', 'brand', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.agency'
        db.delete_column('main_spy_group', 'agency')

        # Deleting field 'Group.brand'
        db.delete_column('main_spy_group', 'brand')
    ...
    models = {
        ...
        'main_spy.post': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main_spy.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_comment_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'last_scanned': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
