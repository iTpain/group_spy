...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DemoObservation.source'
        db.add_column('main_spy_demoobservation', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=16), keep_default=False)

        # Changing field 'LatestDemogeoObservation.source'
        db.alter_column('main_spy_latestdemogeoobservation', 'source', self.gf('django.db.models.fields.CharField')(max_length=16))


    def backwards(self, orm):
        
        # Deleting field 'DemoObservation.source'
        db.delete_column('main_spy_demoobservation', 'source')
