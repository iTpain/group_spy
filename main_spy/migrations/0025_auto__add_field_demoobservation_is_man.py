...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DemoObservation.is_man'
        db.add_column('main_spy_demoobservation', 'is_man', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DemoObservation.is_man'
        db.delete_column('main_spy_demoobservation', 'is_man')
