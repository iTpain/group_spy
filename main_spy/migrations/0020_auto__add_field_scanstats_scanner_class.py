...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScanStats.scanner_class'
        db.add_column('main_spy_scanstats', 'scanner_class', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScanStats.scanner_class'
        db.delete_column('main_spy_scanstats', 'scanner_class')
