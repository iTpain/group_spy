...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'GroupObservation', fields ['date']
        db.create_index('main_spy_groupobservation', ['date'])


    def backwards(self, orm):
        
        # Removing index on 'GroupObservation', fields ['date']
        db.delete_index('main_spy_groupobservation', ['date'])
