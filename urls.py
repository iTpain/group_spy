...
urlpatterns = patterns('',
    ...
    url(r'group(?P<group_id>\d+)/latest_demogeo_snapshot/$', 'main_spy.stat_views.get_demogeo_snapshot'),
    url(r'group(?P<group_id>\d+)/demographics_series/(?P<time_start>[0-9]+)/(?P<time_end>[0-9]+)/$', 'main_spy.stat_views.get_demographics_series'),
    ...
    url(r'text_category(?P<category_id>\d+)/update/$', 'main_spy.crud_views.update_text_category'),
    url(r'text_category(?P<category_id>\d+)/delete/$', 'main_spy.crud_views.remove_text_category'),
